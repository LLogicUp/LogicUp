...
TEST_CASES = [
    ...
    },
    {
        ...
        "error_log": "런타임 에러",
        "expected_categories": ["오프바이원 (off-by-one)", "배열 범위 초과"],
        "levels": [1, 2, 3],
    },
    {
        "id": "c_null_pointer",
    ...
    # ── Python ────────────────────────────────────────────────────────────────
    {
        ...
        "expected_categories": ["리스트 인덱스 오류 (IndexError)"],
        "levels": [1, 2],
    },
    {
        "id": "py_int_division",
    ...
    },
    {
        ...
        "expected_output": "10",
        "code": "count = 0\ndef increment():\n    count += 1\nfor _ in range(10):\n    increment()\nprint(count)",
        "error_log": "UnboundLocalError: local variable 'count' referenced before assignment",
